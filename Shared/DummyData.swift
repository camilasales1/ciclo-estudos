...
struct DummyData{
  static var studyCicle = StudyCicle(name: "Meu Ciclo de Estudos", testDate: Calendar.current.date(from: DateComponents(year: 2023, month: 7, day: 19)) ?? Date(), subjects: subjects, TotalHours: 90, StudyDailyTime: 3)

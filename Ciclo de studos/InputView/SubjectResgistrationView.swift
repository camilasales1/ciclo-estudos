      ...
      Form(){
        ...
        VStack {
          ...
          Button("Adicionar Matéria"){
            inputViewModel.addSubject(subject: Subject(name: inputViewModel.subjectName, weight: inputViewModel.weight, dificult: inputViewModel.dificulty, totalQuestions: inputViewModel.numberOfQuestions,remainingTime: inputViewModel.remainingTime,relevance: inputViewModel.relevance))
